...
const TestimonialSection: React.FC<Props> = ({
  ...
  return (
    <div className="main-grid-columns grid gap-y-9 bg-water  py-16 lg:bg-transparent ">
      <div className="col-[content-start_/_content-end] flex w-full items-center justify-center lg:col-[full-start_/_col-end_4] lg:aspect-[4/3] lg:rounded-br-[5rem] lg:bg-water lg:bg-darkWater lg:p-12 xl:col-[full-start_/_col-end_3] xl:p-16 2xl:p-18 3xl:px-24">
        <HeadingGroup
      ...
      <div className="col-[content-start_/_content-end] w-full lg:col-[col-start_5_/_full-end] lg:row-start-1 lg:flex lg:h-full lg:items-center lg:p-9 xl:col-[col-start_4_/_full-end] xl:px-16 2xl:px-24 3xl:px-48">
        <Carousel
          withDots
