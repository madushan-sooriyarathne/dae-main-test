...
const CTASection: React.FC<Props> = ({
  ...
  return (
    <section className="main-grid-columns grid">
      <div className="col-content grid w-full grid-cols-1 items-start justify-items-start gap-y-8 rounded-2xl bg-water bg-darkWater px-4 py-9 sm:px-6 md:px-8 md:py-12 mlg:grid-cols-[1fr_max-content] mlg:items-center mlg:gap-x-8 lg:py-16 xl:gap-x-16 ">
