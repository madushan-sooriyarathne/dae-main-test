    ...
    <nav className="fixed top-0 left-0 right-0 z-[200] flex h-20 flex-row items-center justify-between bg-white py-3 px-2 shadow-md sm:px-3 md:px-4 md:py-2 lg:py-3 lg:px-6 xl:px-9 2xl:px-16">
      ...
      <div className="grid h-full grid-cols-[repeat(2,_max-content)] grid-rows-[1fr] items-center justify-end gap-x-2 sm:gap-x-4 md:gap-x-8 lg:gap-x-9 xl:gap-x-12">
        ...
        <div
          ...
          className="flex aspect-square h-12 cursor-pointer flex-col items-end justify-center gap-2 p-2"
        >
          <div
            className={`h-[2px] w-full origin-right rounded-sm bg-black-700 transition-[opacity,_transform,_rotate] duration-200 ease-in-out ${
              sideMenuOpen ? "translate-y-[-2px] -rotate-45" : ""
            }`}
          />
          <div
            className={`h-[2px] w-1/2 origin-right rounded-sm bg-black-700 transition-[opacity,_transform,_rotate] duration-200 ease-in-out ${
