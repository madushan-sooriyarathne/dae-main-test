...
const waterSportsFormSchema = z.object({
  ...
  selectedWaterSports: z
    .enum(waterSports)
    .array()
    .nonempty({ message: "At least 1 water sport type should be selected." }),
  date: z
        ...
        <div className="w-full">
          ...
          >
            ...
            <Controller
              ...
              name="selectedWaterSports"
              render={({
                field: { name, onChange, value },
                formState: { errors },
              }) => (
                <MultiSelectGroup
                  options={waterSports as unknown as string[]}
                  label="Planned Water Sport types"
                  name={name}
                  onValueChange={onChange}
                  value={value}
                  error={errors.selectedWaterSports?.message}
                  required
                />
              )}
            />
